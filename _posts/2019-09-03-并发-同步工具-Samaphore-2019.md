...
```
当前线程:Thread[1,5,main]【获取】信号量，已获取信号：[Thread[1,5,main]],剩余可用信号量：1
当前线程:Thread[2,5,main]【获取】信号量，已获取信号：[Thread[1,5,main], Thread[2,5,main]],剩余可用信号量：0
当前线程:Thread[1,5,main]<<释放>>信号量，已获取信号：[Thread[2,5,main], Thread[3,5,main]],剩余可用信号量：0
当前线程:Thread[3,5,main]【获取】信号量，已获取信号：[Thread[2,5,main], Thread[3,5,main]],剩余可用信号量：0
当前线程:Thread[2,5,main]<<释放>>信号量，已获取信号：[Thread[3,5,main]],剩余可用信号量：1
当前线程:Thread[4,5,main]【获取】信号量，已获取信号：[Thread[4,5,main], Thread[3,5,main]],剩余可用信号量：0
当前线程:Thread[3,5,main]<<释放>>信号量，已获取信号：[Thread[5,5,main], Thread[4,5,main]],剩余可用信号量：0
当前线程:Thread[5,5,main]【获取】信号量，已获取信号：[Thread[5,5,main], Thread[4,5,main]],剩余可用信号量：0
当前线程:Thread[4,5,main]<<释放>>信号量，已获取信号：[Thread[5,5,main]],剩余可用信号量：1
当前线程:Thread[5,5,main]<<释放>>信号量，已获取信号：[],剩余可用信号量：2
